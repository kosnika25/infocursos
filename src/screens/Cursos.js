      ...
      <div className={styles.coursesGrid}>
        ...
        <div className={styles.courseCard}>
          ...
          <div className={styles.courseContent}>
            ...
            <p>
              Sistemas para Internet envolve o desenvolvimento e gerenciamento de aplicações web modernas.
            </p>
          </div>
        </div>
        ...
        <div className={styles.courseCard}>
          ...
          <div className={styles.courseContent}>
            ...
            <p>
              A gestão da tecnologia da informação envolve administrar os recursos e sistemas de TI de uma organização.
            </p>
          </div>
        </div>
